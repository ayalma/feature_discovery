...
class FeatureDiscovery extends StatefulWidget {
  static _Bloc _blocOf(BuildContext context) {
    FeatureDiscovery state =
        context.ancestorWidgetOfExactType(FeatureDiscovery);
    assert(state != null,
  ...
  static void dismiss(BuildContext context) => _blocOf(context)._dismiss();
  ...
  FeatureDiscovery({Key key, @required this.child})
      : _bloc = _Bloc(),
        super(key: key);
